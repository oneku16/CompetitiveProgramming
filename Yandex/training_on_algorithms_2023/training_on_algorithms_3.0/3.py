...
def solve() -> Any:
    ...
    n = read_int()
    diego_cards = tuple(set(read_nums(True)))
    k = read_int()
    collector_cards = read_nums()
    answer = [0] * k
    for index, collector_card in enumerate(collector_cards):
        answer[index] = bisect_left(diego_cards, collector_card)
